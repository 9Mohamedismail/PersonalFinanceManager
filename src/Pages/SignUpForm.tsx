  ...
  return (
    <div className="py-10 px-4 lg:px-8">
      <div className="h-full flex flex-col max-w-sm sm:max-w-md md:max-w-xl mx-auto">
        ...
        <p className="text-base sm:text-base lg:text-lg text-gray-900 lg:text-center">
          Track your spending, grow your savings, and reach your goals all in
          one place. Already have an account?{" "}
          <a href="signup" className="cursor-pointer font-bold text-secondary">
            Log in.
          </a>
        </p>
